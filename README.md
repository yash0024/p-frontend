A full stack phonebook using React for the frontend, and Node.js, Express.js, Morgan (middleware), nodemon, and MongoDB (Mongoose) for the backend. Deployed on Heroku.
